package com.mrfuzzihead.archimedes.client.render;
...
public class TileEntityGaugeRenderer extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation GAUGE_TEXTURE_DEFAULT = new ResourceLocation(
        "archimedesships",
        "textures/blocks/gauge.png");
    public static final ResourceLocation GAUGE_TEXTURE_AIRSHIP = new ResourceLocation(
        "archimedesships",
        "textures/blocks/gauge_ext.png");
    ...
    public void renderGauge(TileEntityGauge tileentity, double x, double y, double z, float partialticks) {
        ...
        if (tileentity.parentShip == null) {
            ...
            velgaugeang = -(tileentity.parentShip.getHorizontalVelocity() * 3.6F * 20) / 60F * 270F; // vel in m/s *
                                                                                                     // Tick rate (20
                                                                                                     // Hz) * 3.6
                                                                                                     // (conversion to
                                                                                                     // km/h) with 60
            ...
            if (tileentity.parentShip.dimension == 0) {
                ...
                northgaugeang = (tileentity.parentShip.ticksExisted + partialticks) * 42F
                    + tileentity.parentShip.rotationYaw / 3F;
            }
        }
        GL11.glPushMatrix();
        ...
        if (extended) {
            ...
            if (tileentity.parentShip == null) {
                ...
                vertgaugeang = MathHelper
                    .clamp_float(((float) tileentity.parentShip.motionY * 3.6F * 20) / 40F * 360F, -90F, 90F);
