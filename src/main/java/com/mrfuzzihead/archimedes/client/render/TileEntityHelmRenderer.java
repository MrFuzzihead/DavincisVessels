...
public class TileEntityHelmRenderer extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation MODEL_HELM = new ResourceLocation("archimedesships", "/model/shipHelm.obj");
    public static final ResourceLocation TEXTURE_HELM = new ResourceLocation("archimedesships", "/model/wood.png");
