...
public class EntityParachute extends Entity implements IEntityAdditionalSpawnData {
    ...
    public EntityParachute(World world, EntityShip ship, int x, int y, int z) {
        ...
        Vec3 vec = Vec3.createVectorHelper(
            x - ship.getMovingWorldChunk()
                .getCenterX(),
            y - ship.getMovingWorldChunk()
                .minY(),
            z - ship.getMovingWorldChunk()
                .getCenterZ());
    ...
    public EntityParachute(World world, Entity mounter, Vec3 vec, double shipPosX, double shipPosY, double shipPosZ,
    ...
    public void readSpawnData(ByteBuf additionalData) {
        if (additionalData.readBoolean() && worldObj != null) {
            ...
            if (worldObj.getEntityByID(entityID) != null) {
                worldObj.getEntityByID(entityID)
                    .mountEntity(this);
            }
        }
    }
