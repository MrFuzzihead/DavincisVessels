package com.mrfuzzihead.archimedes.common.tileentity;
...
import com.mrfuzzihead.archimedes.common.network.AssembleResultMessage;
...
import com.mrfuzzihead.movingworld.common.entity.MovingWorldInfo;
...
public class TileEntityHelm extends TileMovingWorldMarkingBlock {
    ...
    public MovingWorldInfo getInfo() {
        if (this.info == null) this.info = new MovingWorldInfo();
        return info;
    }
