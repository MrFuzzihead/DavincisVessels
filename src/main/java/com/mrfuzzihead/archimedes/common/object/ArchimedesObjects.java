package com.mrfuzzihead.archimedes.common.object;
...
import com.mrfuzzihead.archimedes.common.object.block.BlockAS;
import com.mrfuzzihead.archimedes.common.object.block.BlockAnchorPoint;
import com.mrfuzzihead.archimedes.common.object.block.BlockCrate;
import com.mrfuzzihead.archimedes.common.object.block.BlockEngine;
import com.mrfuzzihead.archimedes.common.object.block.BlockGauge;
import com.mrfuzzihead.archimedes.common.object.block.BlockHelm;
import com.mrfuzzihead.archimedes.common.object.block.BlockSeat;
import com.mrfuzzihead.archimedes.common.object.item.ItemGaugeBlock;
import com.mrfuzzihead.archimedes.common.tileentity.TileEntityAnchorPoint;
import com.mrfuzzihead.archimedes.common.tileentity.TileEntityCrate;
import com.mrfuzzihead.archimedes.common.tileentity.TileEntityEngine;
import com.mrfuzzihead.archimedes.common.tileentity.TileEntityGauge;
import com.mrfuzzihead.archimedes.common.tileentity.TileEntityHelm;
...
public class ArchimedesObjects {
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        blockMarkShip = (BlockHelm) new BlockHelm().setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":marker");
        blockMarkShip.setStepSound(Block.soundTypeWood)
            .setHardness(1F)
            .setResistance(1F);
        registerBlock("marker", blockMarkShip);

        blockFloater = new BlockAS(materialFloater).setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":floater");
        blockFloater.setStepSound(Block.soundTypeWood)
            .setHardness(1F)
            .setResistance(1F);
        registerBlock("floater", blockFloater);

        blockBalloon = new BlockColored(Material.cloth).setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":balloon");
        blockBalloon.setStepSound(Block.soundTypeCloth)
            .setHardness(0.35F)
            .setResistance(1F);
        ...
        blockGauge = (BlockGauge) new BlockGauge().setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":gauge");
        blockGauge.setStepSound(Block.soundTypeMetal)
            .setHardness(1F)
            .setResistance(1F);
        registerBlock("gauge", blockGauge, ItemGaugeBlock.class);

        blockSeat = (BlockSeat) new BlockSeat().setHardness(1F)
            .setResistance(1F)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":seat");
        blockSeat.setStepSound(Block.soundTypeCloth);
        registerBlock("seat", blockSeat);

        blockBuffer = new BlockAS(Material.cloth).setHardness(1F)
            .setResistance(1F)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":buffer");
        blockBuffer.setStepSound(Block.soundTypeWood);
        registerBlock("buffer", blockBuffer);

        blockStickyBuffer = new BlockAS(Material.cloth).setHardness(1F)
            .setResistance(1F)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":stickyBuffer");
        blockStickyBuffer.setStepSound(Block.soundTypeMetal);
        registerBlock("stickyBuffer", blockStickyBuffer);

        blockEngine = new BlockEngine(Material.iron, 1f, 10).setHardness(2F)
            .setResistance(3F)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":engine");
        blockEngine.setStepSound(Block.soundTypeMetal);
        registerBlock("engine", blockEngine);

        blockCrateWood = new BlockCrate(Material.wood).setHardness(1f)
            .setResistance(1f)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":crate_wood");
        blockCrateWood.setStepSound(Block.soundTypeWood);
        registerBlock("crate_wood", blockCrateWood);

        blockAnchorPoint = new BlockAnchorPoint(Material.wood).setHardness(1f)
            .setResistance(1F)
            .setCreativeTab(ArchimedesShipMod.creativeTab)
            .setBlockTextureName("archimedesships" + ":anchorPoint");
    ...
    public void init(FMLInitializationEvent e) {
        ...
        // GameRegistry.addRecipe(new ItemStack(blockBalloon, 1), "X", "#", Character.valueOf('X'), Block.cloth,
        // Character.valueOf('#'), Item.silk);
        for (int i = 0; i < ItemDye.field_150923_a.length; i++) {
            GameRegistry.addRecipe(
                new ItemStack(blockBalloon, 1, i),
                "X",
                "#",
                Character.valueOf('X'),
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(blockStickyBuffer), blockFloater, new ItemStack(Items.slime_ball));

        GameRegistry.addRecipe(
            new ItemStack(blockCrateWood, 3),
            " # ",
            "# #",
            "XXX",
            Character.valueOf('#'),
        ...
        GameRegistry.addRecipe(
            new ItemStack(blockAnchorPoint, 1),
            "XYX",
            "XXX",
            "ZZZ",
            Character.valueOf('X'),
