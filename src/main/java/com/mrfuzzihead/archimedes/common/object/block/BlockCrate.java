...
public class BlockCrate extends BlockContainer {
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
        if (!(entity instanceof EntityPlayer) && entity instanceof EntityLivingBase
            || (entity instanceof EntityBoat && !(entity instanceof EntityShip))
    ...
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityplayer, int side, float dx,
        float dy, float dz) {
        TileEntity te = world.getTileEntity(x, y, z);
        if (te instanceof TileEntityCrate) {
