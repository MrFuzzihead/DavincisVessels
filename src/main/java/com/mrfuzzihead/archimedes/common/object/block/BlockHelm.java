...
import com.mrfuzzihead.movingworld.common.block.BlockMovingWorldMarker;
import com.mrfuzzihead.movingworld.common.util.RotationHelper;
...
public class BlockHelm extends BlockDirectional implements IEntitySelector, ITileEntityProvider {
    ...
    public boolean isEntityApplicable(Entity entity) {
        return !(entity instanceof EntityLivingBase) && !(entity instanceof EntityShip)
            && !(entity instanceof EntitySeat)
